...
export const docusearchCaseStudy: CaseStudyContent = {
  ...
  understanding: {
    title: 'Understanding the Users (Both Human and AI)',
    content: [
    ...
    keyInsights: [
      'Both humans and AI agents need transparency, just in different forms',
  ...
  solution: {
    ...
    content: [
      ...
      'Humans interact through visual browsing: Card-based library with thumbnails, audio player with waveform visualization, image carousel for presentations, and full-text transcripts for audio files.',
      '',
      ...
      'Instead of hiding documents in a database, I built everything on the filesystem. Documents live in a real directory structure, AI agents can use standard file operations, humans can access files directly if needed, and the system orchestrates between file storage and vector embeddings.',
      '',
  ...
  impact: {
    ...
    content: [
      ...
      '2. File-native beats database-native - Agents prefer filesystem operations, humans want direct access',
